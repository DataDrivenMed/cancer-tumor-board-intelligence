...
.fx-product{font-size:17px;font-weight:760;color:var(--fx-ink);letter-spacing:-.02em}.fx-author{font-size:11px;color:var(--fx-muted);margin-top:2px}.fx-mode{font-size:10px;color:var(--fx-muted);text-align:right}
...
.fx-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin:14px 0 24px}.fx-card{background:#fff;border:1px solid var(--fx-line);border-radius:14px;padding:17px;box-shadow:0 1px 2px rgba(16,24,40,.03)}.fx-card h3{font-size:14px;margin:8px 0 6px;color:var(--fx-ink)}.fx-card p{font-size:11px;line-height:1.55;color:var(--fx-muted);margin:0}.fx-icon{width:28px;height:28px;border-radius:8px;background:var(--fx-blue-soft);color:var(--fx-blue);display:grid;place-items:center;font-size:10px;font-weight:850;border:1px solid #dbe9f6}
.fx-method{display:grid;grid-template-columns:1fr 34px 1fr 34px 1fr 34px 1fr;align-items:center;gap:8px;background:linear-gradient(180deg,#fff,#fbfcfe);border:1px solid var(--fx-line);border-radius:18px;padding:20px;box-shadow:var(--fx-shadow);margin:14px 0 24px}.fx-node{min-height:112px;border-radius:14px;padding:15px;background:#fff;border:1px solid var(--fx-line)}.fx-node strong{display:block;font-size:13px;color:var(--fx-ink);margin-bottom:5px}.fx-node span{font-size:10px;line-height:1.45;color:var(--fx-muted)}.fx-arrow{text-align:center;color:#98a2b3;font-size:19px}
...
.fx-context{display:grid;grid-template-columns:1.1fr .9fr .9fr 1fr 2fr;gap:8px;border:1px solid var(--fx-line);background:#fff;border-radius:12px;padding:9px 10px;margin:8px 0 14px;box-shadow:0 1px 2px rgba(16,24,40,.03)}.fx-context div{min-width:0}.fx-lbl{font-size:8px;text-transform:uppercase;letter-spacing:.09em;color:var(--fx-muted);font-weight:800}.fx-val{font-size:11px;color:var(--fx-ink);font-weight:650;margin-top:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.fx-question .fx-val{white-space:normal}
.fx-synthetic{display:inline-flex;align-items:center;gap:5px;padding:4px 8px;border-radius:999px;background:var(--fx-violet-soft);color:var(--fx-violet);font-size:9px;font-weight:800;border:1px solid #e4dcff;margin-bottom:8px}
.fx-thirty{background:linear-gradient(140deg,#102b43,#193f60);color:#fff;border-radius:18px;padding:20px 22px;box-shadow:var(--fx-shadow);margin:8px 0 18px}.fx-thirty-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.fx-thirty-title{font-size:21px;font-weight:750}.fx-thirty-sub{font-size:10px;color:#bdd1df;margin-top:3px}.fx-thirty-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:9px;margin-top:15px}.fx-thirty-cell{background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.11);border-radius:11px;padding:11px}.fx-thirty-cell .fx-lbl{color:#a9c2d4}.fx-thirty-cell .fx-val{color:#fff;white-space:normal;font-size:12px}
.fx-decision-banner{background:#fff;border:1px solid var(--fx-line);border-left:5px solid var(--fx-blue);border-radius:14px;padding:18px 20px;box-shadow:var(--fx-shadow);margin:10px 0 14px}.fx-decision-banner h2{font-size:26px;letter-spacing:-.5px;margin:4px 0}.fx-decision-banner p{font-size:12px;color:var(--fx-muted);line-height:1.5;margin:4px 0 0}
.fx-panel-title{font-size:17px;font-weight:760;color:var(--fx-ink);margin:16px 0 4px}.fx-panel-sub{font-size:11px;color:var(--fx-muted);margin-bottom:10px}
.fx-challenge{background:linear-gradient(145deg,#2a3140,#1e2530);color:#fff;border-radius:15px;padding:17px;margin:10px 0}.fx-challenge .fx-panel-title{color:#fff;margin:0 0 5px}.fx-challenge p{color:#cbd5df;font-size:11px;line-height:1.5;margin:0}
.fx-missing{background:var(--fx-amber-soft);border:1px solid #f2d58d;border-radius:14px;padding:15px}.fx-missing strong{font-size:13px;color:#6f4d00}.fx-missing p{font-size:11px;color:#7a5b15;line-height:1.5;margin:5px 0 0}
...
.fx-status-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin:14px 0}.fx-status{border:1px solid var(--fx-line);border-radius:12px;padding:13px;background:#fff}.fx-status strong{font-size:12px;display:block}.fx-status span{font-size:10px;color:var(--fx-muted);display:block;margin-top:4px}
.fx-program-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin-top:12px}.fx-program{border:1px solid var(--fx-line);border-radius:12px;padding:13px;background:#fff}.fx-program strong{font-size:12px;color:var(--fx-ink)}.fx-program span{display:block;font-size:9px;color:var(--fx-muted);margin-top:4px}
.fx-footer{border-top:1px solid var(--fx-line);margin-top:34px;padding:14px 0 4px;font-size:9px;color:var(--fx-muted);display:flex;justify-content:space-between;gap:14px}
[data-testid="stExpander"] summary p::after{content:"  ·  View details";font-size:9px;color:#7c8798;font-weight:600}
...
def top_navigation(active: str) -> None:
    cols = st.columns([1,1,1,1,3], gap="small")
    links = [
    ...
    for col, (page, label, key) in zip(cols[:4], links):
        with col:
